...
; imported
	...
	dba Sfx_Jump
	dba Sfx_Descend
	dba Sfx_GameFreakLogoChaos
	dba Sfx_Blink2
	dba Sfx_Burnout
	dba Sfx_Fall
	dba Sfx_StopInMidAir
	dba Sfx_Dash
	dba Sfx_SonicBoom
	dba Sfx_EmailNotification
	dba Sfx_RecieveItem
	dba Sfx_CatchItem
	dba Sfx_RegisterEmailBoops
	dba Sfx_UniversityTM
	dba Sfx_AlmaMaterFanfare
	dba Sfx_PlaneLanding
