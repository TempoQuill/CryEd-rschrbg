...
Sfx_UnincludedFanfare:
	db	$c4
	dw	Sfx_UnincludedFanfare_Ch1
	db	$05
	dw	Sfx_UnincludedFanfare_Ch2
	db	$06
	dw	Sfx_UnincludedFanfare_Ch3
	db	$07
	dw	Sfx_UnincludedFanfare_Ch4
;----------------------------------------
Sfx_UnincludedFanfare_Ch1:
;----------------------------------------
	db	$df
	db	$da,$00,$76
	db	$e5,$77
