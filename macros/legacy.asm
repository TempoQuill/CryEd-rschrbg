...
force_stereo_panning EQUS "stereo_panning"
unknownmusic0xe7 EQUS "relative_pitch"
unknownmusic0xe8 EQUS "envelope_sequence"
unknownmusic0xee EQUS "sound_jump_ram"
music0xf1 EQUS "pitch_inc_switch"
toggle_perfect_pitch EQUS "pitch_inc_switch"
music0xf2 EQUS "frame_swap"
music0xf3 EQUS "set_music"
execute_music EQUS "set_music"
music0xf4 EQUS "octave_pluck_on"
music0xf5 EQUS "plucks_off"

MACRO music0xf6
	db duty_sequence_cmd
ENDM

music0xf7 EQUS "fifths_pluck_on"
music0xf8 EQUS "toggle_tie_slur"
